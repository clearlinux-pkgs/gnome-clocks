...
%prep
%setup -q -n gnome-clocks-3.38.0
cd %{_builddir}/gnome-clocks-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600271645
...
cp %{_builddir}/gnome-clocks-3.38.0/LICENSE.md %{buildroot}/usr/share/package-licenses/gnome-clocks/13d2034b5ee3cb8d1a076370cf8f0e344a5d0855
