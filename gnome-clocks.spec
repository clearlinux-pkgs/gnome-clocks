...
Version  : 42.0
Release  : 12
URL      : https://download.gnome.org/sources/gnome-clocks/42/gnome-clocks-42.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-clocks/42/gnome-clocks-42.0.tar.xz
...
%prep
%setup -q -n gnome-clocks-42.0
cd %{_builddir}/gnome-clocks-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647897541
...
cp %{_builddir}/gnome-clocks-42.0/LICENSE.md %{buildroot}/usr/share/package-licenses/gnome-clocks/13d2034b5ee3cb8d1a076370cf8f0e344a5d0855
