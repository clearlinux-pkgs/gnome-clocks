...
Version  : 48.0
Release  : 37
URL      : https://download.gnome.org/sources/gnome-clocks/48/gnome-clocks-48.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-clocks/48/gnome-clocks-48.0.tar.xz
...
%prep
%setup -q -n gnome-clocks-48.0
cd %{_builddir}/gnome-clocks-48.0
pushd ..
cp -a gnome-clocks-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742586527
