...
Source0  : https://download.gnome.org/sources/gnome-clocks/41/gnome-clocks-41.0.tar.xz
...
%prep
%setup -q -n gnome-clocks-41.0
cd %{_builddir}/gnome-clocks-41.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634579152
...
cp %{_builddir}/gnome-clocks-41.0/LICENSE.md %{buildroot}/usr/share/package-licenses/gnome-clocks/13d2034b5ee3cb8d1a076370cf8f0e344a5d0855
