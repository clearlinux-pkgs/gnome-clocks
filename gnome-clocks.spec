...
Version  : 3.36.0
Release  : 6
URL      : https://download.gnome.org/sources/gnome-clocks/3.36/gnome-clocks-3.36.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-clocks/3.36/gnome-clocks-3.36.0.tar.xz
...
%prep
%setup -q -n gnome-clocks-3.36.0
cd %{_builddir}/gnome-clocks-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585860821
...
cp %{_builddir}/gnome-clocks-3.36.0/LICENSE.md %{buildroot}/usr/share/package-licenses/gnome-clocks/13d2034b5ee3cb8d1a076370cf8f0e344a5d0855
